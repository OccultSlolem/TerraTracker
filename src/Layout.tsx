  ...
  return (
    <Box bg={useColorModeValue("gray.100", "gray.900")} px={4}>
      <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
        <Box>
          <Heading className="cursor-pointer" onClick={() => navigate('/')}>🌎🔍 TerraTracker</Heading>
        </Box>
        <AccountDropdown />
      </Flex>
    </Box>
...
function AccountDropdown() {
  ...
  function doActionAndClose(action: 'sign-in' | 'sign-up' | 'settings' | 'trackers') {
    onClose();
      ...
      <PopoverContent p={5}>
        ...
        <VStack spacing={4}>
          ...
          <SignedIn>
            ...
            <Button onClick={() => doActionAndClose('trackers')} colorScheme="green">My Trackers</Button>
    ...
    >
      ...
      >
        ...
        <span>
          ...
          |
          <a href="https://github.com/occultslolem/TerraTracker/LICENSE.md" className="text-blue-500 ml-2">
